...
export const translations = {
  en: {
    ...
    advice: {
      ...
      yieldReduced: "Yield may be significantly reduced due to water shortage",
      defaultTips: [
        "Use drip irrigation",
      ...
      waterSavingTips: [
        "Consider switching to a less water-intensive crop",
  ...
  hi: {
    ...
    advice: {
      ...
      yieldReduced: "पानी की कमी के कारण उपज काफी कम हो सकती है",
      defaultTips: [
      ...
      waterSavingTips: [
        "कम पानी वाली फसल पर विचार करें",
        "वर्षा जल संचयन करें",
        "वाष्पीकरण कम करने के लिए मल्चिंग करें",
        "सिंचाई प्रणाली में रिसाव जांचें",
      ],
    },
  },
};
