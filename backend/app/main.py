...
from .routes import water_status, health, ml, auth, admin, ads, dev_docs, sowing_swap
...
# Browsers automatically decompress gzipped responses
...
app.include_router(sowing_swap.router)
